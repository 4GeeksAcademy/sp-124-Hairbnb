...
export const ApptFormBarber = () => {
    ...
    return (
        <div className="container mt-4">
            <h2 className="text-center mb-4">{isEditing ? "Editar cita" : "Nueva cita"}</h2>
            <form onSubmit={handleSubmit} className="card p-4 shadow-sm border-0">
                ...
                <div className={`mb-3 ${isEditing ? 'd-none' : ''}`}>
                    ...
                    {foundUser ? (
                        ...
                        <div className="input-group">
                            <input type="text" className="form-control" placeholder="Teléfono del cliente..." value={phoneSearch} onChange={e => setPhoneSearch(e.target.value)} />
                ...
                <div className={`mb-4 ${isCalendarDisabled ? "opacity-50" : ""}`} style={{ pointerEvents: isCalendarDisabled ? 'none' : 'auto' }}>
                    <label className="form-label fw-bold">Fecha programada</label>
                        ...
                        <div className="d-flex flex-wrap gap-2">
                            {availableSlots.length > 0 ? (
                                ...
                                <div className="w-100 text-center py-2 bg-light rounded">
                                    <small className="text-muted">{data.date ? "Sin huecos libres" : "Selecciona día"}</small>
                                </div>
                            )}
                        </div>
                    </div>
                ...
                <div className="mb-4">
                    ...
                    <textarea className="form-control" rows="2" value={data.notes} onChange={e => setData({ ...data, notes: e.target.value })} placeholder="Ej: Trae el pelo lavado..."></textarea>
                </div>
